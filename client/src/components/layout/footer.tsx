    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/videos">
                  <a className="text-gray-400 hover:text-white transition-colors">Videos</a>
                </Link>
              </li>
              <li>
                <Link href="/articles">
                  <a className="text-gray-400 hover:text-white transition-colors">Articles</a>
                </Link>
              </li>
              <li>
                <Link href="/community">
                  <a className="text-gray-400 hover:text-white transition-colors">Community</a>
                </Link>
              </li>
              <li>
                <Link href="/store">
                  <a className="text-gray-400 hover:text-white transition-colors">Store</a>
                </Link>
              </li>
            </ul>
          </div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/membership">
                  <a className="text-gray-400 hover:text-white transition-colors">Join Now</a>
                </Link>
              </li>
              <li>
                <Link href="/auth">
              ...
              <li>
                <Link href="/membership">
                  <a className="text-gray-400 hover:text-white transition-colors">Membership Benefits</a>
                </Link>
              </li>
              <li>
                <Link href="/membership">
        ...
        <div className="border-t border-gray-700 mt-10 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">© {new Date().getFullYear()} S3VN Studies. All rights reserved.</p>
          <div className="flex space-x-6">
            <Link href="/contact">
              <a className="text-gray-400 hover:text-white transition-colors text-sm">Contact Us</a>
            </Link>
            <Link href="/support">
              <a className="text-gray-400 hover:text-white transition-colors text-sm">Support</a>
            </Link>
            <Link href="/sitemap">
              <a className="text-gray-400 hover:text-white transition-colors text-sm">Sitemap</a>
            </Link>
          </div>
        </div>
      </div>
